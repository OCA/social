...
export class SocialKanbanModel extends RelationalModel {
     ...
     * @returns {Object} result with a `success` flag and a `message`.
     * @description
     * Hook meant to be overridden by each social media module to like
     * the given post on the social network. The base implementation
     * always reports the action as unavailable.
     */
    onLikePost(record) {
        if (!record) {
