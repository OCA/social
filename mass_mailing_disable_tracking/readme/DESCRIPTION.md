...
1.  Tracking the “opening” of the email message by including a 1-pixel
    ...
    recipient. As soon as the recipient displays the remote images of
    the message, their email client downloads the tracking image and the
    Odoo instance knows that that particular recipient opened that
    particular message.
