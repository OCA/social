...
The calendar view is added to the posts action of *Social Media Base*,
which belongs to another module and is therefore not reverted by Odoo on
uninstall. Uninstalling *Social Media Calendar* removes the calendar
mode from that action, so the Posts menu keeps working with its kanban,
list and form views.
