...
class TestMailAcivityBoard(BaseFunctionalTest):

    @classmethod
    def setUpClass(cls):
        super(TestMailAcivityBoard, cls).setUpClass()
...
class TestMailAcivityBoardCases(TransactionCase):

    def setUp(self):
        super(TestMailAcivityBoardCases, self).setUp()
