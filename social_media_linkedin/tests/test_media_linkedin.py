...
class TestSocialMediaLinkedin(TestSocialCommonLinkedin):
    ...
    def test_get_linkedin_scopes_asks_only_for_what_it_calls(self):
        ...
        The modules depending on this one append the scopes of their own
        calls, so what is checked is that the ones of this module head the
        authorization, not that they are the only ones requested.
        """
        self.assertEqual(
            _SCOPE_LINKEDIN,
            [
