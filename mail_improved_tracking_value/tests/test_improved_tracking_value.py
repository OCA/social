        ...
        r = self.model.create(
            {
                ...
                "field_info": {"type": "char", "desc": "desc"},
            }
        )
        ...
        r = self.model.create(
            {
                ...
                "new_value_char": "456",
                "field_id": self.env["ir.model.fields"]._get("res.partner", "name").id,
                "field_info": {"type": "many2many", "desc": "desc"},
            }
        )
        ...
        r = self.model.create(
            {
                ...
                "new_value_char": "456",
                "field_id": self.env["ir.model.fields"]._get("res.partner", "name").id,
                "field_info": {"type": "one2many", "desc": "desc"},
            }
        )
        self.assertEqual(r.old_value_formatted, "123")
        self.assertEqual(r.new_value_formatted, "456")
        ...
        r = self.model.create(
            {
                ...
                "new_value_integer": 3,
                "field_id": self.env["ir.model.fields"]._get("res.partner", "name").id,
                "field_info": {"type": "integer", "desc": "desc"},
            }
        )
        ...
        r = self.model.create(
            {
                ...
                "field_id": self.env["ir.model.fields"]._get("res.partner", "name").id,
                "field_info": {"type": "float", "desc": "desc"},
            }
        )
        ...
        r = self.model.create(
            {
                ...
                "field_id": self.env["ir.model.fields"]._get("res.partner", "name").id,
                "field_info": {"type": "monetary", "desc": "desc"},
            }
        )
        ...
        r = self.model.create(
            {
                ...
                "field_id": self.env["ir.model.fields"]._get("res.partner", "name").id,
                "field_info": {"type": "datetime", "desc": "desc"},
            }
        )
        ...
        r = self.model.create(
            {
                ...
                "new_value_text": "next",
                "field_id": self.env["ir.model.fields"]._get("res.partner", "name").id,
                "field_info": {"type": "text", "desc": "desc"},
            }
        )
