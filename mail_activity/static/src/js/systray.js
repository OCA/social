odoo.define('mail.systray.activities', function (require) {
"use strict";
...
var ActivityMenu = Widget.extend({
    ...
    /**
     * Make call to model and get current user's activity details
     * @private
     */
    _getActivityData: function(){
        var self = this;
        self.model = new Model("res.users")
    ...
    _getActivityModelViewID: function (model) {
        ...
        return self.model.call("get_activity_view_id", [],{});
    },
    /**
