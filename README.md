...
[mail_optional_autofollow](mail_optional_autofollow/) | 14.0.1.0.0 |  | Choose if you want to automatically add new recipients as followers on mail.compose.message
