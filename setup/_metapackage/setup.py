...
setuptools.setup(
    ...
    version=version,
    install_requires=[
        'odoo-addon-attachment_mimetype_restriction>=15.0dev,<15.1dev',
        ...
        'odoo-addon-mail_autogenerated_header>=15.0dev,<15.1dev',
        ...
        'odoo-addon-mail_message_restrict>=15.0dev,<15.1dev',
        ...
        'odoo-addon-mail_send_confirmation>=15.0dev,<15.1dev',
